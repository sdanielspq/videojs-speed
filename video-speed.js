...
(function(videojs) {
	videojs.plugin('speed', function(options) {
		...
		player.ready(function() {
			// only for HTML5 player, but not iOS because iOS uses native HTML5 video player
			if (player.techName.toLowerCase().indexOf('html5') != -1 && vjs.IS_IOS === false) {
				...
				player.defaultPlaybackRate = selectedItem.options().rate;
